...
This is an example of application of physics informed neural networks (PINNs). If you want to know more details, please refer to Final [`Report.pdf`](https://github.com/GwangWooKim/SIR-modeling/blob/main/Final%20Report.pdf) in this repository that contains backgrounds, methods, results, and discussion.
